...
const WalkingOptionsSection = (
  ...
  <div className="walk-options-container">
    <fieldset>
      <legend className="walking-subheader settings-header">
        <FormattedMessage id="walking-mode" defaultMessage="Walking" />
      </legend>
      ...
      <div className="toggle-container walk-option-inner">
        ...
        <label htmlFor="settings-toggle-avoid-walking" className="toggle-label">
