...
/**
 * The default validity period (3650 days = 10 years for OKC, was 5 minutes for HSL) for an alert without a set end time.
 * # 233
 */
export const DEFAULT_VALIDITY = 60 * 60 * 24 * 365 * 10;
